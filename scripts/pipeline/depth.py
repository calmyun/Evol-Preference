base_instruction = "I want you act as a Prompt Rewriter.\r\n \
					Your objective is to rewrite a given prompt into a more complex version to make those famous AI systems (e.g., chatgpt and GPT5) a bit harder to handle.\r\n \
...
# 通过添加额外的约束/限制来增加提示词的复杂度,return增加限制后的prompt
...
# 通过增加查询的深度和广度来增加提示词的复杂度,return增加深度广度后的prompt
...
# 通过将模糊的概念替换为具体的概念来增加提示词的复杂度,return增加具体概念后的prompt
